...
if __name__ == '__main__':
    rospy.init_node('depth_image_converter_left')
    
    # Create a ROS publisher for the converted depth image
    converted_depth_pub = rospy.Publisher('/camera_left/depth/image_new', Image, queue_size=1)
    
    # Create a ROS subscriber for the original depth image
    depth_image_sub = rospy.Subscriber('/camera_left/depth/image_raw', Image, depth_image_callback)
